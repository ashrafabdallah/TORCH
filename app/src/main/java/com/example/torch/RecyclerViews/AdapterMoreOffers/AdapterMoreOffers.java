package com.example.torch.RecyclerViews.AdapterMoreOffers;
...
public class AdapterMoreOffers extends RecyclerView.Adapter<AdapterMoreOffers.MyHolder> {
    private List<Datum> datalist;
    private Context context;
    private SharedPreferences sharedPreferences;
    private String jwt;

    public AdapterMoreOffers(Context context) {
