package com.example.torch.RecyclerViews.AdapterProductDetails;
...
public class AdaterprodutDetail extends RecyclerView.Adapter<AdaterprodutDetail.MyHolder> {
    private List<Product> products;
    private Context context;
    private SharedPreferences sharedPreferences;

    public AdaterprodutDetail(Context context) {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, int position) {
        ...
        holder.textDes.setText(product.getDescription());
        holder.textPrice.setText(String.valueOf(product.getFinalPrice()));
