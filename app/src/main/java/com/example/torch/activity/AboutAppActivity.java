...
import com.example.torch.activity.settings.PolicyActivity;
...
private TextView text_Data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar=findViewById(R.id.actionbarAbout);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeButtonEnabled(true);
        TextView textTiltel = findViewById(R.id.textMain);
        textTiltel.setText(R.string.aboutApp);
    ...
    private void FeatchData() {
        ...
        Call<ResponseBody> call = api.getabout("ar");
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if(response.isSuccessful())
                {
                    ...
                    try {
                        Toast.makeText(AboutAppActivity.this, response.errorBody().string(), Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
